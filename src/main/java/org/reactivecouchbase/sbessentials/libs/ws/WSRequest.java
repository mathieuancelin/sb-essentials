...
public class WSRequest {
    ...
    public WSRequest withBody(JsValue body) {
        ...
        return new WSRequest(system, materializer, connectionFlow, host, path, method, source, ContentTypes.APPLICATION_JSON, headers, queryString, requestTimeout, followsRedirect, virtualHost);
    }

    public WSRequest withBody(String body) {
        Source<ByteString, ?> source = Source.single(ByteString.fromString(body));
        return new WSRequest(system, materializer, connectionFlow, host, path, method, source, ContentTypes.TEXT_PLAIN_UTF8, headers, queryString, requestTimeout, followsRedirect, virtualHost);
    }
    ...
    public WSRequest withHeader(String name, String value) {
        ...
        return new WSRequest(system, materializer, connectionFlow, host, path, method, body, contentType, _headers, queryString, requestTimeout, followsRedirect, virtualHost);
    }
