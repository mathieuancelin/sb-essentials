...
public class TestController {
    ...
    public static Action LogAfter = (req, block) -> block.apply(req).andThen(ttry -> {
        logger.info(
    ...
    public final static String VERY_HUGE_TEXT = IntStream.rangeClosed(1, 100).mapToObj(a -> HUGE_TEXT).collect(Collectors.joining("\n"));
}
